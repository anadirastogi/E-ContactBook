    ...
    <body>
        <div class="container">
			...
			<header>
			  ...
			  <h2><i>Sorry! could not change password</i></h2>
			...
			<section class="main">
				<form class="form-2">
					<h1><span class="log-in">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;New and confirm password</span>  <span class="sign-up">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;not same</span></h1>
					<p class="float">
					<p class="clearfix"> 
						<a href="changepassword.php" class="trylogin">Try again</a>    
