    ...
    <body>
        <div class="container">
			...
			<header>
			  ...
			    
			  <h2><i><b><strong>New User register here</strong></b></i></h2>
			...
			<section class="main">
				<form class="form-2" action="create.php" method="post">
					<h1><span class="log-in">New User ! Fill in ur info</span>
					<p class="float">
						<label for="login"><i class="icon-user"></i>Username</label>
						<input type="text" name="login" placeholder="Username or email">
					
                    
						<label for="oldpassword"><i class="icon-lock"></i>Password</label>
						<input type="password" name="oldpassword" placeholder="Password" >
                        
                        <label for="newpassword"><i class="icon-lock"></i>Confirm Password</label>
                    ...
                    <br/>
						    <a href="../index.php" class="backtologin">Back to Login</a> 
                            	...
                            	<input type="submit" name="submit" value="Create Account" align="center">
