...
<html lang="en">
    ...
    <body>
        <div class="container">
			...
			<section class="main">
				<form class="form-2">
					<h1><span class="log-in"></span>  <span class="sign-up"> </span>username already exists or invalid entry</h1>
					<p class="float">
					<p class="clearfix"> 
						<a href="newuser.php" class="trylogin">Try again</a>    
