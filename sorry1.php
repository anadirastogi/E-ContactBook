    ...
    <body>
        <div class="container">
			...
			<header>
			  ...
			  <h2><i>Sorry! could not log in</i></h2>
			...
			<section class="main">
				<form class="form-2">
					<h1><span class="log-in">you logged out</span> or <span class="sign-up">session expired</span></h1>
					<p class="float">
					<p class="clearfix"> 
						<a href="index.php" class="trylogin">Click here to login again</a>    
