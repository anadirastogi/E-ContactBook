...
<body>
    <div class="container">
		...
		<header>
		  ...
		  <h2><i>Delete a contact from your contactbook</i></h2>
		...
		<section class="main">
			<form class="form-2" action="delete2.php" method="post">
...
if(empty($_SESSION['user']))
					...
					{
						echo  $_SESSION['user'];
					}?> </span><span class="sign-up"> delete from your contactbook</span></h1>
				<p class="float">
