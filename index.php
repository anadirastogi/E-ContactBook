...
<html lang="en">
    ...
    <body>
        <div class="container">
			...
			<section class="main">
				<form class="form-2" action="index2.php" method="post">
					<h1><span class="log-in">Log in</span> or <span class="sign-up">sign in</span><a href="newuser/newuser.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>Sign Up</u></a></h1>
					<p class="float">
					...
					<p class="clearfix"> 
						<a href="changepassword/changepassword.php" class="changepassword">Change Password</a>    
